...
nl.AppConflict_Description=Er is een programma op jouw computer gevonden dat onder bepaalde%n omstandigheden mogelijk conflicteert met Lyrion Music Server.%n%nAls je problemen ondervindt met het gebruik van Lyrion Music Server, neem dan contact op met de technische support.%n%nGa naar https://forums.slimdevices.com voor meer informatie.
...
nl.ManageService=Opstartopties voor Lyrion Music Server
...
nl.PingProblem_Solution=Dit is misschien een tijdelijk internetprobleem, of een beperking die door jouw internet provider is opgelegd.%n%nAls het probleem zich blijft voordoen, zorg er dan voor dat jouw firewall geen uitgaand verkeer blokkeert.
...
nl.Port9000busyOther=Poort 9000 is bezet en wordt misschien door een andere toepassing gebruikt. Lyrion Music Server lijkt niet te worden uitgevoerd.
...
nl.PrefsExistButPortConflict=We hebben een probleem gedetecteerd.%n%nLyrion Music Server gebruikt poort 9000 om via jouw netwerk te communiceren, en er is mogelijk een conflict met een andere toepassing die dezelfde poort gebruikt.%n%nAls je problemen ondervindt met het starten van Lyrion Music Server, bewerk je het voorkeurenbestand van Lyrion Music Server en verander je de waarde van de poort.%n%nZoek hiervoor naar 'server.prefs' op je computer en bewerk dat bestand in Kladblok. Zoek de ingang voor 'httpport' en verander deze van 9000 naar 9010 of 9100. Sla het bestand op en sluit het. Hiermee wordt het conflict opgelost en kan Lyrion Music Server worden uitgevoerd.%n%nGa naar https://forums.slimdevices.com voor meer informatie.
...
nl.ProgressForm_Description=Laten we jouw systeem eens onderzoeken
...
nl.Startup_Caption=Beheer Squeezebox Service
...
nl.Startup_CredentialsRequired=Als je jouw gebruikersnaam en wachtwoord niet invoert, wordt Lyrion Music Server als 'anonieme' systeemgebruiker uitgevoerd en kun je misschien niet bij je muziekcollectie. Wil je verdergaan als anonieme gebruiker?
...
nl.Startup_LabelAtBootDesc_Caption0=Voer je Windows-gebruikersnaam en -wachtwoord in om Lyrion Music Server toegang tot jouw muziekcollectie te geven.
...
nl.Startup_PasswordsDontMatch=De wachtwoorden komen niet overeen. Probeer het opnieuw.
...
nl.Startup_RadioAtBootCustom_Caption0=Lyrion Music Server &automatisch starten met aangepaste inloggegevens.
...
nl.Startup_DisableService_Caption0=Schakel de achtergrondservice van Lyrion Music Server uit.
...
nl.UnregisterServices=Registratie van services wordt geannuleerd
